        ...
        <div class="card border-0 shadow-sm rounded-4 w-100">
            <div class="card-body p-4 p-md-5">
                ...
                <div class="d-flex align-items-center mb-4 pb-3 border-bottom">
                    ...
                    <h5 class="card-title fw-semibold mb-0">Edit Data Kategori</h5>
                </div>
                ...
                <form action="{{ route('kategori.update', $kategori->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama" id="nama" class="form-control form-control-lg rounded-3 @error('nama') is-invalid @enderror" value="{{ old('nama', $kategori->nama) }}" placeholder="Contoh: Tanaman Obat" required>
                    </div>

                    <div class="mb-4">
                        <label for="deskripsi" class="form-label fw-semibold text-dark">Deskripsi Kategori</label>
                        <textarea name="deskripsi" id="deskripsi" class="form-control rounded-3 @error('deskripsi') is-invalid @enderror" rows="4" placeholder="Tuliskan keterangan singkat mengenai kategori ini...">{{ old('deskripsi', $kategori->deskripsi) }}</textarea>
